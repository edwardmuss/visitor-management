...
Route::get('sub_user', [SubUserController::class, 'index'])->name('users');
...
Route::get('sub_user/edit/{id}', [SubUserController::class, 'edit'])->name('sub_user.edit');
...
Route::post('visitor/view_validation', [VisitorController::class, 'view_validation'])->name('visitor.view_validation');
...
Route::get('visitor/get-contact-person', [VisitorController::class, 'getContactPerson'])->name('visitor.get-contact-person');